...
FACT_LINEITEM AS (
    ...
    LEFT JOIN STG_SUPPLIER S ON LI.SUPPLIERKEY = S.SUPPLIERKEY
    LEFT JOIN STG_REGION R ON LI.REGIONKEY = R.REGIONKEY
    LEFT JOIN STG_PART P ON LI.PARTKEY = P.PARTKEY  -- Corrected reference to LI.PARTKEY
    LEFT JOIN STG_CUSTOMER C ON LI.CUSTKEY = C.CUSTKEY
)
